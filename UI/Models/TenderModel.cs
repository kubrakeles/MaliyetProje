namespace UI.Models
{
    public class TenderModel
    {
        ...
        public string OpproximateCost { get; set; } //Yaklaşık Belediye
        ...
        public string PreviousOpproximateCoast { get; set; } //Bir önceki yaklaşık Belediye
        public string PreviousOCTotal { get; set; } //Bir önceki yaklaşık Belediye tutar 
        ...
        public string OpproximateCostAfterTender { get; set; } // ihale sonrası güncellenmiş yaklaşık Belediye
